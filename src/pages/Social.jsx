...
import { Instagram, Youtube, Twitter, Clapperboard, ShoppingBag } from 'lucide-react';
...
const Social = () => {
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 8 }}>
      <SectionHeader title="The Social Hub" subtitle="Follow the journey, the characters, and the chaos." />
      
      <Box sx={{ mb: 8, display: 'flex', justifyContent: 'center', gap: 1.5, flexWrap: 'wrap' }}>
        <Button 
          variant="outlined" 
        ...
        <Button 
          variant="outlined" 
          href="https://x.com/brianjoralvarez" 
          target="_blank"
        ...
        <Button 
          variant="outlined" 
          href="https://instagram.com/brianjordanalvarez" 
          target="_blank"
        ...
        <Button 
          variant="outlined" 
          href="https://www.cameo.com/brianjordanalvarez" 
          target="_blank"
          startIcon={<Clapperboard size={18} />}
          sx={{ borderRadius: 100, px: 3 }}
        >
        ...
        <Button 
          variant="outlined" 
          href="https://venmo.com/u/brianjordanalvarez" 
          target="_blank"
      ...
      <Box sx={{ mb: 8 }}>
        ...
        <Grid container spacing={6}>
          ...
          <Grid size={12}>
            <Box sx={{ width: '100%', maxWidth: '1000px', mx: 'auto' }}>
              <Typography variant="subtitle1" sx={{ fontWeight: 700, mb: 2, display: 'flex', alignItems: 'center', gap: 1 }}>
                <Youtube color="#FF0000" size={20} /> Watch on YouTube
              </Typography>
              <SocialFeed type="youtube" url="https://www.youtube.com/embed/videoseries?list=UU0bBXn_fmXlleQAdRH6wHQw" />
            </Box>
          </Grid>
        </Grid>
      </Box>

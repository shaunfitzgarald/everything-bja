...
const Watch = () => {
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 8 }}>
      ...
      {/* Featured Video */}
      <Box sx={{ mb: 8 }}>
        <Typography variant="h5" sx={{ fontWeight: 800, mb: 3 }}>Featured Video</Typography>
        <Box sx={{ position: 'relative', pt: '56.25%', borderRadius: 6, overflow: 'hidden', boxShadow: '0 20px 50px rgba(0,0,0,0.1)' }}>
          {configLoading ? <Skeleton variant="rectangular" sx={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }} /> : (
            <iframe

      ...
      <Container maxWidth="lg">
        <Grid container spacing={4} justifyContent="space-between">
          <Grid size={{ xs: 12, sm: 4 }}>
            <Box 
              ...
              to="/" 
              sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 2, textDecoration: 'none' }}
            >
              <img src="/assets/logo.png" alt="Everything BJA Logo" style={{ height: '28px' }} />
          ...
          <Grid size={{ xs: 12, sm: 4 }}>
            ...
            <Box sx={{ display: 'flex', gap: 1.5, flexWrap: 'wrap' }}>
              ...
              <IconButton component="a" href="https://www.youtube.com/@BrianJordanAlvarez" target="_blank" color="inherit" size="small">
                <Youtube size={20} />
              </IconButton>
              <IconButton component="a" href="https://letterboxd.com/actor/brian-jordan-alvarez/" target="_blank" color="inherit" size="small">
        ...
        <Box sx={{ mt: 5, pt: 3, borderTop: '1px solid', borderColor: 'divider', textAlign: 'center' }}>
          ...
          <Typography variant="caption" color="text.secondary" sx={{ opacity: 0.7 }}>
            Made with ❤️ by <Link href="https://shaunfitzgarald.com" target="_blank" color="inherit" sx={{ textDecoration: 'none', '&:hover': { textDecoration: 'underline' } }}>shaunfitzgarald</Link>.
          </Typography>
        </Box>
      </Container>
    </Box>
